...
#ifndef BIDMACHINEAPICORE_SWIFT_H
#define BIDMACHINEAPICORE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BidMachineApiCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC17BidMachineApiCore24BidMachineAsyncOperation")
@interface BidMachineAsyncOperation : NSOperation
